...
namespace Xmu.Crms.HighGrade.Controllers
{
   ...
   // [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class SeminarController : Controller
    {
        ...
        [HttpGet]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public IActionResult GetSeminarMy([FromRoute]int seminarId)
        {
        ...
        [HttpGet]
        public IActionResult GetSeminarTopic([FromRoute]int seminarId)
        {
        ...
        [Route("seminar/{seminarId}/topic")]
        [HttpPost]
        public IActionResult PostSeminarTopic([FromRoute]int seminarId, [FromBody]Topic topic)
        {
        ...
        [HttpGet]
        public IActionResult GetSeminarGroup([FromRoute]int seminarId, Boolean gradeable, [FromRoute]int classId)
        {
